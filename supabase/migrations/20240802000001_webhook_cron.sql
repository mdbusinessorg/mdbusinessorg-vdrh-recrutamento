...
SELECT cron.schedule('scrape-jobs-hourly', '0 * * * *', 'SELECT net.http_post(''https://noywnuafpxvxvmfkjtbh.supabase.co/functions/v1/scrape-jobs'', NULL, ''{}''::jsonb, ''{"Content-Type":"application/json"}''::jsonb, 60000);');
